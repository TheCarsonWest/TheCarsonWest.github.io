...
Because force and acceleration are vectors, we often analyze them using component vectors in a Cartesian coordinate system. This is particularly useful when analyzing [Forces and Free-Body Diagrams](./../forces-and-free-body-diagrams/).
...
Since  $ \vec{p} = m\vec{v} $ , if mass is constant, this derivative simplifies back to the familiar  $ F=ma $ . You can find further details on this relationship in [Change in Momentum and Impulse](./../change-in-momentum-and-impulse/).
...
2.  **Draw a Free-Body Diagram (FBD):** Sketch the object and draw all forces acting *on* it. Refer to [Forces and Free-Body Diagrams](./../forces-and-free-body-diagrams/) for best practices.
...
*   **External vs. Internal Forces:** Newton's Second Law only considers *external* forces. Internal forces (forces between objects within your chosen system) cancel out due to [Newtons Third Law](./../newtons-third-law/).
*   **Non-Constant Forces:** If the force is not constant, you must use calculus to integrate the acceleration over time or position, linking back to [Work](./../work/) and energy principles.