...
- The source code for this markdown file is what you are reading right now, and the source file is ./[non programming things about python](./../non-programming-things-about-python/).md
# Compilation
