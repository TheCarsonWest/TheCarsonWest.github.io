...
- [Modules and Packages](./../modules-and-packages/): PyPI is used to distribute and manage Python [Modules and Packages](./../modules-and-packages/).
...
- [Virtual Environments](./../virtual-environments/): PyPI packages can be installed into [Virtual Environments](./../virtual-environments/) to isolate them from other packages.
