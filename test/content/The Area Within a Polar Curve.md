+++
 title = 'The Area Within a Polar Curve'
[params]
	author = 'Carson West'
+++
# [Calc home](./../calc-home/)
...
The area  $ A $  of a region bounded by the polar curve  $ r = f(\theta) $  and radial lines  $ \theta = \alpha $  and  $ \theta = \beta $  is given by:
 $$ A = \int_{\alpha}^{\beta} \frac{1}{2} r^2 d\theta $$  where  $ r $  is expressed as a function of  $ \theta $ .
...
The area  $ A $  between two polar curves  $ r_{outer} = f(\theta) $  and  $ r_{inner} = g(\theta) $  from  $ \theta = \alpha $  to  $ \theta = \beta $  is:
 $$ A = \int_{\alpha}^{\beta} \frac{1}{2} (r_{outer}^2 - r_{inner}^2) d\theta $$  Ensure that  $ r_{outer} $  is always greater than or equal to  $ r_{inner} $  in the region of interest. Finding the intersection points of the two curves is often necessary to determine  $ \alpha $  and  $ \beta $ .
