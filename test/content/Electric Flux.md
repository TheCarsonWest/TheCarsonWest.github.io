...
Electric flux is a fundamental concept in electromagnetism that quantifies the amount of electric field passing through a specific surface. It serves as the gateway to understanding [Gausss Law](./../gausss-law/), which is a powerful tool for calculating electric fields in highly symmetric charge distributions.
...
This relationship between the flux through a closed surface and the enclosed charge is the precise foundation of [Gausss Law](./../gausss-law/).