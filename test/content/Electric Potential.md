...
Electric potential, denoted by  $ V $ , is defined as the [Electric Potential Energy](./../electric-potential-energy/) ( $ U_E $ ) per unit charge ( $ q $ ). It essentially measures the "voltage" at a specific point in space.
...
Because potential is a scalar (not a vector), we simply add the values without needing to worry about directional components. This makes solving for potential generally easier than solving for the [Electric Fields](./../electric-fields/).
