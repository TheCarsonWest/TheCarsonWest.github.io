...
This temperature dependency is critical when designing [Simple Circuits](./../simple-circuits/) that may be subject to extreme heat, as the resistance of components may drift from their nominal values.
...
To understand why these relationships exist, we must look at the movement of charge carriers. The relationship between current density ( $ J $ ) and the electric field ( $ E $ ) within a conductor is given by the microscopic form of Ohm's Law:
 ...
 $$ J = \sigma E $$  
Where  $ \sigma = 1/\rho $  is the conductivity of the material. This concept relates directly to the behavior of particles discussed in [Electric Current](./../electric-current/).