...
Conservation of energy is a fundamental principle in physics. When applied to electric systems, it states that the total energy in an isolated electric system remains constant. This is a specific application of the broader concept of [Conservation of Energy](./../conservation-of-energy/) to the electric field and electric potential.
...
For a point charge  $ q $  in the presence of another charge  $ Q $  at a distance  $ r $ :
 $$ U_E = k\frac{qQ}{r} $$  
For a more comprehensive look at these definitions, refer to [Electric Potential Energy](./../electric-potential-energy/) and [Electric Potential](./../electric-potential/).
...
When a charge moves from an initial point ( $ i $ ) to a final point ( $ f $ ), the change in kinetic energy is equal to the negative change in potential energy:
 ...
 $$ \Delta K + \Delta U_E = 0 $$   $$ K_f - K_i = -(U_{E,f} - U_{E,i}) $$  
...
When a charged particle (like an electron or proton) is released from rest in an electric field, its potential energy is converted entirely into kinetic energy. 
 ...
 $$ K_f = q(V_i - V_f) $$   $$ \frac{1}{2}mv^2 = q\Delta V $$  
...
This connects directly to the concept of [Work](./../work/), where we analyze the displacement of objects under the influence of force. If you are examining more complex circuits or field interactions, it is often helpful to reference [Electric Fields](./../electric-fields/) to determine the path and magnitude of the potential difference.