...
This concept is the direct analog to [Electric Flux](./../electric-flux/) studied in electrostatics. While Gauss's Law for electricity relates electric flux to enclosed charge, the magnetic version, Gauss's Law for Magnetism, states that the net magnetic flux through any closed surface is always zero:

 $$ \oint \vec{B} \cdot d\vec{A} = 0 $$  
This result implies that there are no "magnetic charges" or monopoles; magnetic field lines must always form continuous closed loops. Understanding this property is essential before moving on to [Induced Currents and Magnetic Forces](./../induced-currents-and-magnetic-forces/).