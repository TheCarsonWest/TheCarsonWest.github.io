+++
 title = 'Geometric Series & the nth-Term Test'
[params]
	author = 'Carson West'
+++
...
This page focuses on two fundamental concepts in the study of infinite series: geometric series, which have a predictable convergence pattern, and the nth-Term Test, a basic test for divergence. These tools are essential for determining the behavior of [Infinite Sequences and Series](./../infinite-sequences-and-series/).
...
*   **The Converse is FALSE:** If  $ \lim_{n \to \infty} a_n = 0 $ , the test is inconclusive. The series **may converge or may diverge**. You must use other tests (e.g., [The Integral Test](./../the-integral-test/), Comparison Tests, etc.) to determine its behavior.
