...
#  $$ f(v) = [4](./../4/)\pi (\frac{m}{[2](./../2/)\pi kT})^{\frac{[3](./../3/)}{[2](./../2/)}} v^[2](./../2/) e^{-\frac{mv^[2](./../2/)}{2kT}} $$  
...
* *k* is the Boltzmann constant ([1](./../1/).38 x 10<sup>-23</sup> [J](./../j/)/K)
