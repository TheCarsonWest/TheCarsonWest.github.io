...
Because the magnetic force is always perpendicular to velocity, it cannot change the speed or kinetic energy of the particle; it acts as a centripetal force, changing only the direction of motion. This leads to [Uniform Circular Motion](./../uniform-circular-motion/) for charged particles in a uniform magnetic field.
...
Solving for the radius ( $ r $ ) of the particle's path:
 ...
 $$ r = \frac{mv}{|q|B} $$  
This relationship is crucial in [Mass Spectrometry](./../mass-spectrometry/) and cyclotron design, where the radius depends directly on the particle's momentum ( $ p=mv $ ).
...
*   **Velocity Selectors:** Combining [Electric Fields](./../electric-fields/) and magnetic fields to allow only particles of a specific velocity to pass through undeflected.