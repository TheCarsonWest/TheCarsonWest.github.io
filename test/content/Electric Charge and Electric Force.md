...
For a deeper dive into the fundamental principles of how these charges are manipulated, see [Conservation of Electric Charge and Charging](./../conservation-of-electric-charge-and-charging/).
...
For a more comprehensive understanding of how these forces generate vector fields in space, refer to [Electric Fields](./../electric-fields/). If you need to understand the relationship between electric force and potential energy, see [Electric Potential Energy](./../electric-potential-energy/).