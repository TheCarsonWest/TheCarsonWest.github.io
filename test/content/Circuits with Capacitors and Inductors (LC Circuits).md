...
An LC circuit consists of an ideal capacitor with capacitance  $ C $  and an ideal inductor with inductance  $ L $  connected in a closed loop. When the capacitor is initially charged and allowed to discharge through the inductor, the circuit exhibits electromagnetic oscillations. This system is the electromagnetic analog to a mechanical mass-spring system undergoing [Defining Simple Harmonic Motion (SHM)](./../defining-simple-harmonic-motion-(shm)/).
