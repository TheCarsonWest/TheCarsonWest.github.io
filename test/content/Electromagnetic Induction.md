...
*    $ \Phi_B $  is the [Magnetic Flux](./../magnetic-flux/).
...
Furthermore, this topic bridges the gap to understanding [Inductance](./../inductance/), where a changing current in one circuit induces an EMF in the same or a nearby circuit due to its own magnetic field. 

One must also be careful to distinguish between these effects and the [Magnetic Fields of Current-Carrying Wires and the Biot-Savart Law](./../magnetic-fields-of-current-carrying-wires-and-the-biot-savart-law/), as induction relies on the *change* of fields, rather than the existence of static fields alone.