...
Now, we evaluate the improper integral:
 $$  \int_{1}^{\infty} \frac{1}{x^p} dx  $$  This integral converges if  $ p > 1 $  and diverges if  $ 0 < p \le 1 $ .
...
This is a very important result often referred to as the [p-Series Test](./../p-series-test/).
