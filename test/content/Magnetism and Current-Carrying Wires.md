...
To find the direction of the force, we use the [Right-Hand Rule](./../right-hand-rule/). Point your fingers in the direction of the current  $ I $  (the direction of  $ \vec{L} $ ), then curl them in the direction of the magnetic field  $ \vec{B} $ . Your thumb will point in the direction of the magnetic force  $ \vec{F_B} $ .
...
For a deeper understanding of how these fields are derived mathematically, see [Ampere's Law](./../ampere's-law/).