...
2.  **Normal Force:** Do not assume  $ F_N = mg $ . If an object is on an incline,  $ F_N = mg \cos(\theta) $ . If there are vertical applied forces,  $ F_N $  must be calculated using [Newtons Second Law](./../newtons-second-law/) in the y-direction.
...
For a broader discussion on forces that oppose motion, see [Resistive Forces](./../resistive-forces/).