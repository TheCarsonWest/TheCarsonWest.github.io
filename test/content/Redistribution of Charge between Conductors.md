...
This phenomenon explains the "lightning rod effect," where charge density becomes so high at sharp points that it can ionize the surrounding air, creating a path for discharge. This relates to the concept of [Electrostatics with Conductors](./../electrostatics-with-conductors/).
