...
- [[Higher-Order [Functions](./../functions/): [Decorators](./../decorators/) are higher-order [functions](./../functions/) that take a function as an argument and return a new function.
