...
| :--- | :--- | :--- |
| [Kirchhoffs Junction Rule](./../kirchhoffs-junction-rule/) | The sum of currents entering a junction equals the sum of currents leaving. | Conservation of Charge |
| [Kirchhoffs Loop Rule](./../kirchhoffs-loop-rule/) | The sum of potential differences around any closed loop is zero. | Conservation of Energy |
...
*   [Resistance, Resistivity, and Ohms Law](./../resistance,-resistivity,-and-ohms-law/) for component-level behavior.
*   [Electric Power](./../electric-power/) to calculate energy dissipation in resistors.
*   [Simple Circuits](./../simple-circuits/) for identifying basic series/parallel patterns before attempting complex loop analysis.